...
public enum PerkType {
    ...
    INCINERATOR(
            "incinerator",
            "§6Incinerador",
            "§7Tus golpes cuerpo a cuerpo prenden fuego al objetivo (perk único)",
    ...
    CRAFTSMAN_MASTERY(
            ...
            "§7§oLos antiguos herreros susurraban que solo un elegido podía\n"
                    + "§7§oarrancarle secretos al metal con sus propias manos.\n"
                    + "§7Tus creaciones ya no nacen comunes: cada herramienta, arma,\n"
                    + "§7escudo, tijera o mechero que fabriques puede emerger ya\n"
                    + "§7encantado (0 a 5 encantamientos compatibles al azar).",
    ...
    PerkType(String id, String displayName, String descriptionFormat, Material icon,
             PerkKind kind, PotionEffectType potionEffectType, Attribute attribute, int requiredLevel) {
        this.id = id;
